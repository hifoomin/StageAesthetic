...
namespace StageAesthetic.Variants.Special
{
    internal class Commencement
    {
        ...
        {
            Skybox.NightSky();
            GameObject.Destroy(GameObject.Find("SceneInfo").GetComponent<PostProcessVolume>());
        ...
        public static void Gray(RampFog fog)
        {
            ...
            fog.fogColorStart.value = new Color32(140, 140, 140, 50);
            fog.fogColorMid.value = new Color32(160, 150, 150, 125);
            fog.fogColorEnd.value = new Color32(90, 90, 100, 180);
            fog.skyboxStrength.value = 0f;
            var sun = GameObject.Find("Directional Light (SUN)");
            sun.SetActive(false);
            ...
            // 0.1138 0.1086 0.15 1
            // 0.1012 0.1091 0.1226 1
            bruh2.overrideAmbientColor = new Color(0.0138f, 0.0086f, 0.05f, 1);
            bruh2.overrideDirectionalColor = new Color(0.0012f, 0.0091f, 0.0226f, 1);
        }
    }
}